!function(e) {
    ...
    AFRAME.registerComponent("particle-system", {
        ...
        update: function(e) {
            ...
            !0 === this.data.enabled ? this.startParticles() : this.stopParticles()
        },
...
, function(e, t, r) {
    ...
    i = o,
    void 0 !== (a = "function" == typeof i ? i.call(t, r, t, e) : i) && (e.exports = a),
    ...
    o.TypedArrayHelper.prototype.setSize = function(e, t) {
        ...
        return t || (e *= this.componentSize),
        e < r ? this.shrink(e) : e > r ? this.grow(e) : void console.info("TypedArray is already of size:", e + ".", "Will not resize.")
    }
    ,
    o.TypedArrayHelper.prototype.shrink = function(e) {
        "use strict";
        return this.array = this.array.subarray(0, e),
        this.size = e,
        this
    }
    ,
    ...
    o.TypedArrayHelper.prototype.setFromArray = function(e, t) {
        ...
        var r = t.length
          , i = e + r;
        return i > this.array.length ? this.grow(i) : i < this.array.length && this.shrink(i),
    ...
    o.TypedArrayHelper.prototype.setNumber = function(e, t) {
        "use strict";
        return this.array[this.indexOffset + e * this.componentSize] = t,
        this
    }
    ,
    ...
    o.ShaderAttribute.prototype.setUpdateRange = function(e, t) {
        "use strict";
        this.updateMin = Math.min(e * this.componentSize, this.updateMin * this.componentSize),
        this.updateMax = Math.max(t * this.componentSize, this.updateMax * this.componentSize)
    }
    ,
    o.ShaderAttribute.prototype.flagUpdate = function() {
        ...
        t.count = Math.min(this.updateMax - this.updateMin + this.componentSize, this.typedArray.array.length),
        e.needsUpdate = !0
    }
    ,
    ...
    o.ShaderAttribute.prototype._createBufferAttribute = function(e) {
        "use strict";
        if (this._ensureTypedArray(e),
        null !== this.bufferAttribute)
            return this.bufferAttribute.array = this.typedArray.array,
    ...
    o.utils = {
        ...
        ensureArrayInstanceOf: function(e, t, r) {
            ...
            if (Array.isArray(e)) {
                for (var i = e.length - 1; i >= 0; --i)
                    if (void 0 !== t && e[i]instanceof t == !1)
                        return r;
                return e
            }
        ...
        ensureValueOverLifetimeCompliance: function(e, t, r) {
            ...
            var i = this.clamp(e._value.length, t, r)
              ...
              , o = Math.max(i, a);
            e._value.length !== o && (e._value = this.interpolateArray(e._value, o)),
            e._spread.length !== o && (e._spread = this.interpolateArray(e._spread, o))
        },
        interpolateArray: function(e, t) {
            ...
            return i.push("function" == typeof e[r - 1].clone ? e[r - 1].clone() : e[r - 1]),
            i
        },
        ...
        zeroToEpsilon: function(e, t) {
            "use strict";
            var r = e;
            return r = t ? 1e-5 * Math.random() * 10 : 1e-5,
            e < 0 && e > -1e-5 && (r = -r),
            r
        },
        lerpTypeAgnostic: function(e, t, r) {
            "use strict";
            var i, a = this.types;
            return typeof e === a.NUMBER && typeof t === a.NUMBER ? e + (t - e) * r : e instanceof THREE.Vector2 && t instanceof THREE.Vector2 ? (i = e.clone(),
            i.x = this.lerp(e.x, t.x, r),
            i.y = this.lerp(e.y, t.y, r),
            i) : e instanceof THREE.Vector3 && t instanceof THREE.Vector3 ? (i = e.clone(),
            i.x = this.lerp(e.x, t.x, r),
            i.y = this.lerp(e.y, t.y, r),
            i.z = this.lerp(e.z, t.z, r),
            i) : e instanceof THREE.Vector4 && t instanceof THREE.Vector4 ? (i = e.clone(),
            i.x = this.lerp(e.x, t.x, r),
            i.y = this.lerp(e.y, t.y, r),
            i.z = this.lerp(e.z, t.z, r),
            i.w = this.lerp(e.w, t.w, r),
            i) : e instanceof THREE.Color && t instanceof THREE.Color ? (i = e.clone(),
            i.r = this.lerp(e.r, t.r, r),
            i.g = this.lerp(e.g, t.g, r),
            i.b = this.lerp(e.b, t.b, r),
            i) : void console.warn("Invalid argument types, or argument types do not match:", e, t)
        },
        lerp: function(e, t, r) {
            "use strict";
            return e + (t - e) * r
        ...
        randomVector3: function(e, t, r, i, a) {
            ...
            a && (o = .5 * -a.x + this.roundToNearestMultiple(o, a.x),
            s = .5 * -a.y + this.roundToNearestMultiple(s, a.y),
            n = .5 * -a.z + this.roundToNearestMultiple(n, a.z)),
        ...
        randomColorAsHex: function() {
            ...
            return function(t, r, i, a) {
                for (var o = i.length, s = [], n = 0; n < o; ++n) {
                    var u = a[n];
                    e.copy(i[n]),
                    e.r += Math.random() * u.x - .5 * u.x,
                    e.g += Math.random() * u.y - .5 * u.y,
                    e.b += Math.random() * u.z - .5 * u.z,
        ...
        getPackedRotationAxis: function() {
            ...
            return function(a, o) {
                return e.copy(a).normalize(),
                t.copy(o).normalize(),
                e.x += .5 * -o.x + Math.random() * o.x,
                e.y += .5 * -o.y + Math.random() * o.y,
                e.z += .5 * -o.z + Math.random() * o.z,
                e.normalize().add(i).multiplyScalar(.5),
    ...
    o.Group = function(e) {
        ...
        this.fixedTimeStep = t.ensureTypedArg(e.fixedTimeStep, r.NUMBER, .016),
    ...
    o.Group.prototype._applyAttributesToGeometry = function() {
        "use strict";
        var e, t, r = this.attributes, i = this.geometry, a = i.attributes;
        for (var o in r)
            r.hasOwnProperty(o) && (e = r[o],
            t = a[o],
            t ? t.array = e.typedArray.array : i.addAttribute(o, e.bufferAttribute),
    ...
    o.Group.prototype.addEmitter = function(e) {
        ...
        if (e instanceof o.Emitter == !1)
            return void console.error("`emitter` argument must be instance of SPE.Emitter. Was provided with:", e);
        ...
        for (var a in t)
            t.hasOwnProperty(a) && t[a]._createBufferAttribute(null !== this.maxParticleCount ? this.maxParticleCount : this.particleCount);
        for (var s = r; s < i; ++s)
    ...
    o.Group.prototype.removeEmitter = function(e) {
        ...
        for (var r = e.attributeOffset, i = r + e.particleCount, a = this.attributes.params.typedArray, s = r; s < i; ++s)
            a.array[4 * s] = 0,
            a.array[4 * s + 1] = 0;
    ...
    o.Group.prototype.releaseIntoPool = function(e) {
        "use strict";
        return e instanceof o.Emitter == !1 ? void console.error("Argument is not instanceof SPE.Emitter:", e) : (e.reset(),
        this._pool.unshift(e),
        this)
    }
    ,
    ...
    o.Group.prototype._triggerSingleEmitter = function(e) {
        ...
        var t = this.getFromPool()
          , r = this;
        return null === t ? void console.log("SPE.Group pool ran out.") : (e instanceof THREE.Vector3 && (t.position.value.copy(e),
    ...
    o.Group.prototype._updateBuffers = function(e) {
        "use strict";
        var t, r, i, a = this.attributeKeys, o = this.attributeCount - 1, s = this.attributes, n = e.bufferUpdateRanges;
        for (o; o >= 0; --o)
            t = a[o],
            r = n[t],
            i = s[t],
    ...
    o.Group.prototype.tick = function(e) {
        "use strict";
        var t, r = this.emitters, i = r.length, a = e || this.fixedTimeStep, o = this.attributeKeys, s = this.attributes;
        if (this._updateUniforms(a),
        this._resetBufferRanges(),
        0 !== i || !1 !== this._attributesNeedRefresh || !1 !== this._attributesNeedDynamicReset) {
            for (var n, t = 0; t < i; ++t)
                n = r[t],
                n.tick(a),
                this._updateBuffers(n);
    ...
    o.Emitter = function(e) {
        ...
        for (var a in this.updateMap)
            this.updateMap.hasOwnProperty(a) && (this.updateCounts[this.updateMap[a]] = 0,
                ...
                Object.defineProperty(e, a, {
                    ...
                    set: function(e) {
                        return function(i) {
                            ...
                            "_rotationCenter" === e ? (r.updateFlags.rotationCenter = !0,
                            r.updateCounts.rotationCenter = 0) : "_randomise" === e ? r.resetFlags[a] = i : (r.updateFlags[a] = !0,
                            r.updateCounts[a] = 0),
    ...
    o.Emitter.prototype._setBufferUpdateRanges = function(e) {
        "use strict";
        this.attributeKeys = e,
        this.attributeCount = e.length;
    ...
    o.Emitter.prototype._assignForceValue = function(e, t) {
        "use strict";
        var r, i, a, s, n, u = o.distributions, l = o.utils, p = this[t], c = p._value, d = p._spread, h = p._distribution;
        switch (h) {
        case u.BOX:
        ...
        case u.DISC:
            ...
            a = r[n + 1],
            s = r[n + 2],
            l.randomDirectionVector3OnDisc(this.attributes[t], e, i, a, s, this.position._value, p._value.x, p._spread.x)
        }
        if ("acceleration" === t) {
    ...
    o.Emitter.prototype._assignAbsLifetimeValue = function(e, t) {
        "use strict";
        var r, i = this.attributes[t].typedArray, a = this[t], s = o.utils;
        s.arrayValuesAreEqual(a._value) && s.arrayValuesAreEqual(a._spread) ? (r = Math.abs(s.randomFloat(a._value[0], a._spread[0])),
        i.setVec4Components(e, r, r, r, r)) : i.setVec4Components(e, Math.abs(s.randomFloat(a._value[0], a._spread[0])), Math.abs(s.randomFloat(a._value[1], a._spread[1])), Math.abs(s.randomFloat(a._value[2], a._spread[2])), Math.abs(s.randomFloat(a._value[3], a._spread[3])))
    }
    ,
    o.Emitter.prototype._assignAngleValue = function(e) {
        "use strict";
        var t, r = this.attributes.angle.typedArray, i = this.angle, a = o.utils;
        a.arrayValuesAreEqual(i._value) && a.arrayValuesAreEqual(i._spread) ? (t = a.randomFloat(i._value[0], i._spread[0]),
        r.setVec4Components(e, t, t, t, t)) : r.setVec4Components(e, a.randomFloat(i._value[0], i._spread[0]), a.randomFloat(i._value[1], i._spread[1]), a.randomFloat(i._value[2], i._spread[2]), a.randomFloat(i._value[3], i._spread[3]))
    }
    ,
    ...
    o.Emitter.prototype._assignRotationValue = function(e) {
        "use strict";
        this.attributes.rotation.typedArray.setVec3Components(e, o.utils.getPackedRotationAxis(this.rotation._axis, this.rotation._axisSpread), o.utils.randomFloat(this.rotation._angle, this.rotation._angleSpread), this.rotation._static ? 0 : 1),
    ...
    o.Emitter.prototype._resetParticle = function(e) {
        ...
        for (var t, r, i = this.resetFlags, a = this.updateFlags, o = this.updateCounts, s = this.attributeKeys, n = this.attributeCount - 1; n >= 0; --n)
            t = s[n],
            r = a[t],
            !0 !== i[t] && !0 !== r || (this._assignValue(t, e),
            this._updateAttributeUpdateRange(t, e),
            !0 === r && o[t] === this.particleCount ? (a[t] = !1,
            o[t] = 0) : 1 == r && ++o[t])
    }
    ,
    o.Emitter.prototype._updateAttributeUpdateRange = function(e, t) {
        ...
        r.min = Math.min(t, r.min),
        r.max = Math.max(t, r.max)
    }
    ,
    o.Emitter.prototype._resetBufferRanges = function() {
        "use strict";
        var e, t = this.bufferUpdateRanges, r = this.bufferUpdateKeys, i = this.bufferUpdateCount - 1;
        for (i; i >= 0; --i)
            e = r[i],
    ...
    o.Emitter.prototype._checkParticleAges = function(e, t, r, i) {
        ...
        for (var a, o, s, n, u = t - 1; u >= e; --u)
            ...
            0 !== (n = r[a]) && (s = r[a + 1],
            o = r[a + 2],
            1 === this.direction ? (s += i) >= o && (s = 0,
            n = 0,
            this._decrementParticleCount()) : (s -= i) <= 0 && (s = o,
            n = 0,
    ...
    o.Emitter.prototype._activateParticles = function(e, t, r, i) {
        ...
        for (var a, o, s = this.direction, n = e; n < t; ++n)
            a = 4 * n,
            0 != r[a] && 1 !== this.particleCount || (this._incrementParticleCount(),
            r[a] = 1,
    ...
    o.Emitter.prototype.reset = function(e) {
        ...
        this.alive = !1,
        !0 === e) {
            for (var t, r = this.attributeOffset, i = r + this.particleCount, a = this.paramsArray, o = this.attributes.params.bufferAttribute, s = i - 1; s >= r; --s)
                t = 4 * s,
                a[t] = 0,
                a[t + 1] = 0;
